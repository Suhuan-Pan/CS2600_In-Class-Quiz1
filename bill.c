...
typedef double (*operation)(char*, double);
...
int main(int argc, char *argv[])
{
 ...
 //    1. validate the # of argument supplied must be 3 (include the .exe)
    ...
    /*
     * 1. declare a pointer to argv[1] with address of it
     * 2. declare a float pointer to it with same address
     * 3. stores the float value in that location
     */
    printf("\n--- Menu ---\n");
